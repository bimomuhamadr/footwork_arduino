void Running1() {
  ...
  else if (digitalRead(tombol2) == 0 && flag[1]) {
    waktuberjalan = millis();
  ...
  else if (digitalRead(tombol3) == 0 && flag[2]) {
    waktuberjalan = millis();
    timer[posisitimer] = waktuberjalan - lasttimer[posisitimer] + timer[posisitimer - 1];
    lasttimer[posisitimer + 1] = waktuberjalan;
    //    Serial.print("timer : ");
  ...
  else if (digitalRead(tombol4) == 0 && flag[3]) {
    waktuberjalan = millis();
    timer[posisitimer] = waktuberjalan - lasttimer[posisitimer] + timer[posisitimer - 1];
    lasttimer[posisitimer + 1] = waktuberjalan;
    //    Serial.print("timer : ");
  ...
  else if (digitalRead(tombol3) == 0 && flag[4]) {
    waktuberjalan = millis();
    timer[posisitimer] = waktuberjalan - lasttimer[posisitimer] + timer[posisitimer - 1];
    lasttimer[posisitimer + 1] = waktuberjalan;
    //    Serial.print("timer : ");
  ...
  else if (digitalRead(tombol2) == 0 && flag[7]) {
    waktuberjalan = millis();
    timer[posisitimer] = waktuberjalan - lasttimer[posisitimer] + timer[posisitimer - 1];
    lasttimer[posisitimer + 1] = waktuberjalan;
    //    Serial.print("timer : ");
