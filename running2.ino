void Running2() {
  ...
  if (digitalRead(tombol2) == 0 && flag[0]) {
  ...
  else if (digitalRead(tombol1) == 0 && flag[2]) {
    waktuberjalan = millis();
    timer[posisitimer] = waktuberjalan - lasttimer[posisitimer] + timer[posisitimer - 1];
    lasttimer[posisitimer + 1] = waktuberjalan;
    //    Serial.print("timer : ");
  ...
  else if (digitalRead(tombol1) == 0 && flag[4]) {
    waktuberjalan = millis();
    timer[posisitimer] = waktuberjalan - lasttimer[posisitimer] + timer[posisitimer - 1];
    lasttimer[posisitimer + 1] = waktuberjalan;
    //    Serial.print("timer : ");
  ...
  else if (digitalRead(tombol3) == 0 && flag[5]) {
    waktuberjalan = millis();
    timer[posisitimer] = waktuberjalan - lasttimer[posisitimer] + timer[posisitimer - 1];
    lasttimer[posisitimer + 1] = waktuberjalan;
    //    Serial.print("timer : ");
  ...
  else if (digitalRead(tombol2) == 0 && flag[6]) {
    waktuberjalan = millis();
    timer[posisitimer] = waktuberjalan - lasttimer[posisitimer] + timer[posisitimer - 1];
    lasttimer[posisitimer + 1] = waktuberjalan;
    //    Serial.print("timer : ");
  ...
  else if (digitalRead(tombol4) == 0 && flag[7]) {
    waktuberjalan = millis();
    timer[posisitimer] = waktuberjalan - lasttimer[posisitimer] + timer[posisitimer - 1];
    lasttimer[posisitimer + 1] = waktuberjalan;
    //    Serial.print("timer : ");
  ...
  else if (digitalRead(tombol2) == 0 && flag[8]) {
    waktuberjalan = millis();
    timer[posisitimer] = waktuberjalan - lasttimer[posisitimer] + timer[posisitimer - 1];
    lasttimer[posisitimer + 1] = waktuberjalan;
    //    Serial.print("timer : ");
  ...
  else if (digitalRead(tombol4) == 0 && flag[9]) {
    waktuberjalan = millis();
    timer[posisitimer] = waktuberjalan - lasttimer[posisitimer] + timer[posisitimer - 1];
    //    Serial.print("timer : ");
    //    Serial.print(timer[posisitimer]);
